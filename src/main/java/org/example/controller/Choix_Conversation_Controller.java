...
public class Choix_Conversation_Controller {
    ...
    void Deriger_Liste_Amis() {
        try {
            ...
            Utilisateur utilisateur = service_utilisateur.getUtilisateurParId(2);
            ...
            conversation.setSujet("Sujet de la conversation");
            ...
            conversation.setDateFin(null); // Date de fin non spécifiée pour le moment
